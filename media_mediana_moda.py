...
sam=[27.94,28.86,25.63,30.61,41.45,22.56,42.88,32.21,15.25,28.89,42.59,22.92,36.22,24.25,33.29]
man=[25.34,9.49,19.17,25.67,16.92,21.60,17.64,12.91,20.01,33.97,14.05,19.81,11.13,14.88,16.22]
# Encontrando as medias
media_sam=mean(sam)
media_man=mean(man)
print(media_sam)
print(media_man)
#encontrando as medianas
median_sam=median(sam)
median_man=median(man)
print(median_sam)
print(median_man)
#encontrando o desvio pardrão dos dados
desvio_sam=stdev(sam)
desvio_man=stdev(man)
print(desvio_sam)